...
export const CarouselHeader = ({ children }: CarouselHeaderProps) => {
  return <div className="carousel-header">{children}</div>;
};
...
export const CarouselBody = <TOption,>({
  children,
  data = [],
  getOptionId = (opt: any) => opt.id,
}: CarouselBodyProps<TOption>) => {
...
export const CarouselFooter = ({ children }: CarouselFooterProps) => {
  return <div className="carousel-footer">{children}</div>;
};
